...
import com.example.LT_Java_Buoi5.model.Book;
...
public class BookController {
    ...
    public String deleteBook(@PathVariable("id") long id, RedirectAttributes redirectAttributes) {
        // Tìm cuốn sách cần xóa trong danh sách
        ...
        listBook.remove(bookToDelete);

        // Thêm thông báo flash về việc xóa thành công
